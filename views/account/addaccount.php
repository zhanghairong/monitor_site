...
<div class="pop_container">
    ...
    <h2 class="title">添加Account</h2>
    <div class="pop_content" style="width: 600px;">
        <div class="errortips">&nbsp;</div>
        <div class="cell_form">
            <form action="<?php echo ConfigManager::$baseurl;?>/Account/AddAccount" method="GET" id="id_add_form">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td><input name="passwd" type="text" class="text" value="" /></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td><span class="tdtitle">privilege</span></td>
                        <td><input name="privilege" type="text" class="text" value="" /></td>
                        <td></td>
                    </tr>
                </table>
                <div class="btn_box">
