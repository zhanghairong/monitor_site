    ...
    <div class="cell_search" style="display: inline-block;position: relative;width: 100%;margin-top: -11px;">
        <div class="">
            <form id="id_search">
                ...
                <a href="javascript:void(0);" onclick="ChartLine.LoadDailyData();" class="btn"><span>查询</span></a>
            </form>
        </div>            
    </div>
    <div id="id_reportdata"> </div>
</div>
...
$(document).ready(function(){
    ...
    ChartLine.LoadDailyData("<?php echo $curvename;?>" + "(日统计)");
});
</script>