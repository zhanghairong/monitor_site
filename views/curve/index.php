...
<div class="main main_server" >
    <div class="content">
         ...
         <div class="sidebar">
            <ul class="menu" id="id_ul_list">
                ...
                <li class="unfold">
                    ...
                    <ul class="sub">
        			    <li onclick="CurveManager.LoadCurve('<?php echo $projectinfo['_id'];?>','<?php echo $curveid;?>');">
        ...
        <!--/sidebar-->
        <div id="id_curve_page"  class="mod_iframe" style="padding: 17px 0 0px 40px;margin-left: 163px;">    
        </div>
    </div>
</div>
