DateInput = (function($) { // Localise the $ function
    ...
    function DateInput(el, opts) {
      ...
      this.input = $(el);
      this.bindMethodsToObj("show", "hide", "hideIfClickOutside", "keydownHandler", "selectDate","dateToString");
    ...
    DateInput.prototype = {
      ...
      stringToDate: function(string) {
        ...
        } else if (matches = string.match(/^(\d{4,4})-(\d{2,2})-(\d{2,2})$/)) {
...
$.extend(DateInput.DEFAULT_OPTS, {
  month_names: ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "12月", "12月"],
  short_month_names: ["1月", "2月", "3月", "4月", "5月", "6月", "7月", "8月", "9月", "10月", "12月", "12月"],
