...
(function() {
    ...
    L = {
        ...
        tooltip: {
            ...
            pointFormat: '<span style="color:{series.color}">¡ñ</span> {series.name}: <b>{point.y}</b><br/>',
            shadow: !0,
            snap: Hb ? 25 : 10,
            style: {
                color: "#333333",
    ...
    ca.scatter = w(T, {
        lineWidth: 0,
        tooltip: {
            headerFormat: '<span style="color:{series.color}">¡ñ</span> <span style="font-size: 10px;"> {series.name}</span><br/>',
